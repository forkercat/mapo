...
namespace mapo
{
	...
	//
	void* AllocateAligned_VersionOne(size_t numBytes, U8 alignment = 4)
	{
	...
	//
	void* AllocateAligned(size_t numBytes, U8 alignment = 4)
	{
	...
	void* AllocateAligned_Modulo(size_t numBytes, U8 alignment = 4)
	{
		size_t actualBytes = numBytes + alignment;
		U8* pOriginal = new U8[actualBytes];
		// Calculate the shift.
